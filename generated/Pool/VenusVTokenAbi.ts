...
export class VenusVTokenAbi__getAccountSnapshotResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class VenusVTokenAbi extends ethereum.SmartContract {
  static bind(address: Address): VenusVTokenAbi {
    return new VenusVTokenAbi("VenusVTokenAbi", address);
  }
  ...
  getAccountSnapshot(
    account: Address
  ): VenusVTokenAbi__getAccountSnapshotResult {
    let result = super.call(
      "getAccountSnapshot",
    ...
    return new VenusVTokenAbi__getAccountSnapshotResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt()
  ...
  try_getAccountSnapshot(
    account: Address
  ): ethereum.CallResult<VenusVTokenAbi__getAccountSnapshotResult> {
    let result = super.tryCall(
      "getAccountSnapshot",
      "getAccountSnapshot(address):(uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(account)]
    ...
    return ethereum.CallResult.fromValue(
      new VenusVTokenAbi__getAccountSnapshotResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt()
  ...
  isVToken(): boolean {
    let result = super.call("isVToken", "isVToken():(bool)", []);

    return result[0].toBoolean();
  }

  try_isVToken(): ethereum.CallResult<boolean> {
    let result = super.tryCall("isVToken", "isVToken():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
