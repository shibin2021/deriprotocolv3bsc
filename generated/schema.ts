...
export class Vault extends Entity {
  ...
  get venusComptroller(): Bytes {
    let value = this.get("venusComptroller");
    return value!.toBytes();
  }

  set venusComptroller(value: Bytes) {
    this.set("venusComptroller", Value.fromBytes(value));
  }

  get venusOracle(): Bytes {
    let value = this.get("venusOracle");
    return value!.toBytes();
  }

  set venusOracle(value: Bytes) {
    this.set("venusOracle", Value.fromBytes(value));
  }
}
